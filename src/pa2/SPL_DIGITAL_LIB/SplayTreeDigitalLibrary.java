...
public class SplayTreeDigitalLibrary{
	...
	public  void returnBook(String authorName) {
		...
		SplayTreeNode<Book> curr2 = new SplayTreeNode<Book>(newbook);
		...
		System.out.print(responseStr);
		output.append(responseStr);
		SplayTreeNode<Book> newBookNodeForAuthorTree = curr1;
		SplayTreeNode<Book> newBookNodeForISBNTree = curr2;
	...
	public  void readFromOrigin() {
		Scanner fileSc = null;
		try {
			fileSc = new Scanner(new File("/Users/nicolezhang/Desktop/src/pa2/SPL_DIGITAL_LIB/spltree_digi_lib_baselib.txt"));
			while(fileSc.hasNext()) {
				String tab = "\t";
				String line ="";
				try {
